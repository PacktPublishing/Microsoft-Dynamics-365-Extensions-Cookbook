...
namespace Microsoft.Crm.Sdk.Samples1
{
    [ServiceBehavior]
    ...
    class EndpointListerner2
    {
        static void Main(string[] args)
        {
            ...
            string serviceNamespace = "sb://dynamics1.servicebus.windows.net/";
            ...
            string issuerSecret = "F9i0i3CR/OK09X8k78g67oRMBx1Z6RXmux3NUNIefjE=";
